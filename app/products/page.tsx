        ...
        <section className="bg-white py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            {products.length > 0 ? (
              ...
              <div className="mx-auto mt-16 max-w-2xl rounded-3xl border border-[#173f2b]/10 bg-[#f5f2e9] p-12 text-center">
                <p className="text-lg font-semibold text-[#173f2b]">
                  Products are being prepared.
                </p>

                <p className="mt-3 text-sm leading-7 text-slate-600">
                  Our product catalogue will be updated shortly.
                </p>
              </div>
            )}
          </div>
...
function ProductCard({
  ...
  return (
    <article className="group overflow-hidden rounded-3xl border border-black/5 bg-white shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
      ...
      <div className="p-7">
        ...
        <div className="mt-6 border-t border-black/5 pt-5">
          <Link
            ...
            className="text-xs font-semibold uppercase tracking-wider text-[#173f2b] transition-colors group-hover:text-[#b78628]"
          >
            View Product →
          </Link>
        </div>
